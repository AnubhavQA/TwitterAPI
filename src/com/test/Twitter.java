...
public class Twitter {
	...
	public JSONObject startTwitterAuthentication()
	{
		...
		String twitter_endpoint = "http://api.twitter.com/oauth/request_token";
		...
		HttpHost host = new HttpHost(twitter_endpoint_host, 80); // use 80 if you want regular HTTP (not HTTPS)
